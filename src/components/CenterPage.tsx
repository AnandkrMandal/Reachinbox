        ...
        <div className="flex items-center space-x-3">
            ...
            <Menu as="div" className="relative ml-3">
              <div>
                <MenuButton className="relative flex text-sm">
                  ...
                  Move <SlArrowDown className="ml-2 mt-1" />
                </MenuButton>
              </div>
              <MenuItems
                transition
                className="absolute right-0 z-10 mt-2 w-48 origin-top-right rounded-md dark:bg-[#1F1F1F] dark:text-white bg-white py-1 shadow-lg ring-1 ring-black ring-opacity-5 transition focus:outline-none data-[closed]:scale-95 data-[closed]:transform data-[closed]:opacity-0 data-[enter]:duration-100 data-[leave]:duration-75 data-[enter]:ease-out data-[leave]:ease-in"
              >
                <MenuItem>
                  <a
                    href="#"
                  ...
                  >
                    <FaEnvelope className="inline-block mr-2" /> Mark as Unread
                  </a>
                </MenuItem>
                <MenuItem>
                  <a
                    ...
                    className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100"
                  >
                    <FaPencilAlt className="inline-block mr-2" /> Edit lead
                  </a>
                </MenuItem>
                <MenuItem>
                  <a
                    ...
                    className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100"
                  >
                    <FaUserMinus className="inline-block mr-2" /> Remove lead
                  </a>
                </MenuItem>
                <MenuItem>
                  <a
                    ...
                    className="block px-4 py-2 text-sm text-gray-700 data-[focus]:bg-gray-100"
                  >
                    <FaBell className="inline-block mr-2" /> Set reminder
                  </a>
                </MenuItem>
                <MenuItem>
                  <a
          ...
          <div className="dark:bg-[#1F1F1F] border bg-white text-black dark:text-white  dark:border-[#343A40] rounded-md py-2 px-3 text-sm">
            <Menu as="div" className="relative">
              <div>
                <MenuButton className="relative flex mt-0 text-sm">
                  <span className="absolute -inset-1.5" />
                  <span className="sr-only">menu</span>
                  ...
                </MenuButton>
